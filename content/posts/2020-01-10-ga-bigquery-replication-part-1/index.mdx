...
author: Saïd Tezel
date: 2020-01-10
slug: ga-bigquery-replication-part-1
hero: ./images/ga-bigquery-replication.jpg
title: Replicate Google Analytics Data on BigQuery – Part 1
---
...
Now that we have successfully managed to create the pipeline, the next step is to automate it. You can check [part 2](/ga-bigquery-replication-part-2) and [part 3](/ga-bigquery-replication-part-3) for the next steps.

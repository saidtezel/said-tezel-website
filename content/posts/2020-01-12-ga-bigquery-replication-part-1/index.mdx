...
Now that we have successfully managed to create the pipeline, the next step is to automate it. You can check [part 2](/ga-bigquery-replication-part-2) for the next steps.
